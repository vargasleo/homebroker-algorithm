...
/**
 *  The {@code broker.heap.MinPQ} class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    // is subtree of pq[1..n] rooted at k a min broker.heap?
